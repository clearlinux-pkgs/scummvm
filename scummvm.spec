...
Version  : 2.8.0
Release  : 27
URL      : https://github.com/scummvm/scummvm/archive/v2.8.0/scummvm-2.8.0.tar.gz
Source0  : https://github.com/scummvm/scummvm/archive/v2.8.0/scummvm-2.8.0.tar.gz
...
%prep
%setup -q -n scummvm-2.8.0
cd %{_builddir}/scummvm-2.8.0
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a scummvm-2.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702962905
