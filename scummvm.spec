...
Version  : 2.5.1
Release  : 13
URL      : https://github.com/scummvm/scummvm/archive/v2.5.1/scummvm-2.5.1.tar.gz
Source0  : https://github.com/scummvm/scummvm/archive/v2.5.1/scummvm-2.5.1.tar.gz
...
%prep
%setup -q -n scummvm-2.5.1
cd %{_builddir}/scummvm-2.5.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640976977
...
cp %{_builddir}/scummvm-2.5.1/COPYING %{buildroot}/usr/share/package-licenses/scummvm/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/scummvm-2.5.1/COPYING.BSD %{buildroot}/usr/share/package-licenses/scummvm/da895920d4a7d4f0920fade3570969cf4d5fafd6
cp %{_builddir}/scummvm-2.5.1/COPYING.FREEFONT %{buildroot}/usr/share/package-licenses/scummvm/e58874a433eec4f975f35cb34379712d3b932f9e
cp %{_builddir}/scummvm-2.5.1/COPYING.ISC %{buildroot}/usr/share/package-licenses/scummvm/1ee6945db9b441059627e2e4a6fd39d0ac1c0d70
cp %{_builddir}/scummvm-2.5.1/COPYING.LGPL %{buildroot}/usr/share/package-licenses/scummvm/091c8f65dffdd24bf8c803d8b97c365d2981bdf5
cp %{_builddir}/scummvm-2.5.1/COPYING.MIT %{buildroot}/usr/share/package-licenses/scummvm/a818dee446e51c8a735a22bc7b036ec4046b67f7
cp %{_builddir}/scummvm-2.5.1/COPYING.OFL %{buildroot}/usr/share/package-licenses/scummvm/ea3155a0218b1c5cb952b1a18f2b601795ba8569
cp %{_builddir}/scummvm-2.5.1/audio/soundfont/VGMTrans_LICENSE.txt %{buildroot}/usr/share/package-licenses/scummvm/14e89807e531a116c2d9d79e5284f195655713b2
cp %{_builddir}/scummvm-2.5.1/common/lua/COPYRIGHT %{buildroot}/usr/share/package-licenses/scummvm/52144cf874618949f7857eb5adb964bf3cd7938f
cp %{_builddir}/scummvm-2.5.1/devtools/tasmrecover/dreamweb/LICENSE %{buildroot}/usr/share/package-licenses/scummvm/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/scummvm-2.5.1/dists/debian/copyright %{buildroot}/usr/share/package-licenses/scummvm/c57e74e2f28fade261732ed7974b22b5b34fb80e
cp %{_builddir}/scummvm-2.5.1/dists/snap/LICENSE %{buildroot}/usr/share/package-licenses/scummvm/25053a3b2190049c9d407b00c3a2ff001a7c066a
cp %{_builddir}/scummvm-2.5.1/graphics/nanosvg/LICENSE.txt %{buildroot}/usr/share/package-licenses/scummvm/f4f94babc436555d2f5992e29aacc47433fbadb4
cp %{_builddir}/scummvm-2.5.1/graphics/tinygl/LICENSE %{buildroot}/usr/share/package-licenses/scummvm/1abf6c39f91742ebaf668258c13cca516a7d47e9
cp %{_builddir}/scummvm-2.5.1/gui/themes/fonts/LICENSE.mplus %{buildroot}/usr/share/package-licenses/scummvm/a70b05899e79e96734d62e59093e646812eba2db
cp %{_builddir}/scummvm-2.5.1/test/cxxtest/COPYING %{buildroot}/usr/share/package-licenses/scummvm/dd4547c72e04fd16fd675556993abb945491a69c
%make_install
