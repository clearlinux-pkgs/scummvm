...
Version  : 2.8.1
Release  : 28
URL      : https://github.com/scummvm/scummvm/archive/v2.8.1/scummvm-2.8.1.tar.gz
Source0  : https://github.com/scummvm/scummvm/archive/v2.8.1/scummvm-2.8.1.tar.gz
Summary  : Allows you to run certain classic graphical point-and-click adventure games.
Group    : Development/Tools
License  : Apache-2.0 BSD-2-Clause BSD-3-Clause BSL-1.0 CC-BY-3.0 GPL-3.0 ISC LGPL-2.1 MIT OFL-1.1 PostgreSQL Zlib
...
%prep
%setup -q -n scummvm-2.8.1
cd %{_builddir}/scummvm-2.8.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a scummvm-2.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710615528
...
cp %{_builddir}/scummvm-%{version}/LICENSES/COPYING.MKV %{buildroot}/usr/share/package-licenses/scummvm/59cd938fcbd6735b1ef91781280d6eb6c4b7c5d9 || :
