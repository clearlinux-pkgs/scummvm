...
Version  : 2.1.0
Release  : 4
URL      : https://github.com/scummvm/scummvm/archive/v2.1.0/scummvm-2.1.0.tar.gz
Source0  : https://github.com/scummvm/scummvm/archive/v2.1.0/scummvm-2.1.0.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-2-Clause BSD-3-Clause Distributable GPL-2.0 GPL-3.0 LGPL-2.1 MIT OFL-1.1 PostgreSQL
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571177763
...
cp %{_builddir}/scummvm-2.1.0/COPYING %{buildroot}/usr/share/package-licenses/scummvm/2b9d60c2972b476384af9900276837ac81954e80
cp %{_builddir}/scummvm-2.1.0/COPYING.BSD %{buildroot}/usr/share/package-licenses/scummvm/da895920d4a7d4f0920fade3570969cf4d5fafd6
cp %{_builddir}/scummvm-2.1.0/COPYING.FREEFONT %{buildroot}/usr/share/package-licenses/scummvm/e58874a433eec4f975f35cb34379712d3b932f9e
cp %{_builddir}/scummvm-2.1.0/COPYING.LGPL %{buildroot}/usr/share/package-licenses/scummvm/091c8f65dffdd24bf8c803d8b97c365d2981bdf5
cp %{_builddir}/scummvm-2.1.0/COPYING.OFL %{buildroot}/usr/share/package-licenses/scummvm/d9a40d0905db5a3d6d1119e0e272ab8018dc092f
cp %{_builddir}/scummvm-2.1.0/common/lua/COPYRIGHT %{buildroot}/usr/share/package-licenses/scummvm/52144cf874618949f7857eb5adb964bf3cd7938f
cp %{_builddir}/scummvm-2.1.0/devtools/tasmrecover/dreamweb/LICENSE %{buildroot}/usr/share/package-licenses/scummvm/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/scummvm-2.1.0/gui/themes/fonts/LICENSE.mplus %{buildroot}/usr/share/package-licenses/scummvm/a70b05899e79e96734d62e59093e646812eba2db
cp %{_builddir}/scummvm-2.1.0/test/cxxtest/COPYING %{buildroot}/usr/share/package-licenses/scummvm/dd4547c72e04fd16fd675556993abb945491a69c
%make_install
