...
Version  : 2.7.1
Release  : 26
URL      : https://github.com/scummvm/scummvm/archive/v2.7.1/scummvm-2.7.1.tar.gz
Source0  : https://github.com/scummvm/scummvm/archive/v2.7.1/scummvm-2.7.1.tar.gz
...
%prep
%setup -q -n scummvm-2.7.1
cd %{_builddir}/scummvm-2.7.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a scummvm-2.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689375854
