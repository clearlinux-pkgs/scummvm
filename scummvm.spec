...
Version  : 2.9.1
Release  : 33
URL      : https://github.com/scummvm/scummvm/archive/v2.9.1/scummvm-2.9.1.tar.gz
Source0  : https://github.com/scummvm/scummvm/archive/v2.9.1/scummvm-2.9.1.tar.gz
...
%prep
%setup -q -n scummvm-2.9.1
cd %{_builddir}/scummvm-2.9.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a scummvm-2.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747074429
