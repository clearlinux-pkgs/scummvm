...
Version  : 2.1.2
Release  : 8
URL      : https://github.com/scummvm/scummvm/archive/v2.1.2/scummvm-2.1.2.tar.gz
Source0  : https://github.com/scummvm/scummvm/archive/v2.1.2/scummvm-2.1.2.tar.gz
...
%prep
%setup -q -n scummvm-2.1.2
cd %{_builddir}/scummvm-2.1.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585687923
...
cp %{_builddir}/scummvm-2.1.2/COPYING %{buildroot}/usr/share/package-licenses/scummvm/2b9d60c2972b476384af9900276837ac81954e80
cp %{_builddir}/scummvm-2.1.2/COPYING.BSD %{buildroot}/usr/share/package-licenses/scummvm/da895920d4a7d4f0920fade3570969cf4d5fafd6
cp %{_builddir}/scummvm-2.1.2/COPYING.FREEFONT %{buildroot}/usr/share/package-licenses/scummvm/e58874a433eec4f975f35cb34379712d3b932f9e
cp %{_builddir}/scummvm-2.1.2/COPYING.LGPL %{buildroot}/usr/share/package-licenses/scummvm/091c8f65dffdd24bf8c803d8b97c365d2981bdf5
cp %{_builddir}/scummvm-2.1.2/COPYING.OFL %{buildroot}/usr/share/package-licenses/scummvm/d9a40d0905db5a3d6d1119e0e272ab8018dc092f
cp %{_builddir}/scummvm-2.1.2/common/lua/COPYRIGHT %{buildroot}/usr/share/package-licenses/scummvm/52144cf874618949f7857eb5adb964bf3cd7938f
cp %{_builddir}/scummvm-2.1.2/devtools/tasmrecover/dreamweb/LICENSE %{buildroot}/usr/share/package-licenses/scummvm/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/scummvm-2.1.2/dists/debian/copyright %{buildroot}/usr/share/package-licenses/scummvm/c57e74e2f28fade261732ed7974b22b5b34fb80e
cp %{_builddir}/scummvm-2.1.2/gui/themes/fonts/LICENSE.mplus %{buildroot}/usr/share/package-licenses/scummvm/a70b05899e79e96734d62e59093e646812eba2db
cp %{_builddir}/scummvm-2.1.2/test/cxxtest/COPYING %{buildroot}/usr/share/package-licenses/scummvm/dd4547c72e04fd16fd675556993abb945491a69c
%make_install
